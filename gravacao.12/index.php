     ...
     <div class="row marcador">
       ...
       <div class="col-md-4">
        <video id="myvideo" width="600" height="200"  id="leftVideo" controls>
                                    ...
                                    <source src= "../grupos/grupo12/1.mp4" type="video/webm" />
                                    <source src= "../grupos/grupo12/1.mp4" type="video/mp4" />
                                    <track id="legenda" label="English" kind="subtitles" srclang="en" src="../legendas/grupo12/1.vtt" default>
                                    <script type="text/javascript">
                                    var j = i;
                                    j++;
                                        document.getElementById("myvideo").src=vids[i];
