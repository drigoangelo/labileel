...
<html lang="pt-br">
    ...
    <head>
        ...
        <!-- Esse eu tenho certeza que vai, pois é em relação ao vídeo -->
    ...
    Essa aqui tinha mas eu nao sabia se era necessária ou não -->
      ...
      var vids = [
        "../grupos/grupo1/1(BEGINS).mp4",
        "../grupos/grupo1/2(BORD).mp4",
        "../grupos/grupo1/3(HOW IS YOUR DAY GOING).mp4",
        "../grupos/grupo1/4(VERY WELL).mp4",
        "../grupos/grupo1/5(SEE YOU).mp4",
        "../grupos/grupo1/6(LATER).mp4",
        "../grupos/grupo1/7(GOOD LUCK).mp4",
];
        ...
        <div class="container-fluid">
            ...
            <div class="container marcador2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 marcador">
                        <video width="600" height="400" id="gum" autoplay muted />
                    </div>
                ...
                <script src="../js/node_modules/popper.js/dist/popper.min.js"/>
                <script src="../js/bootstrap.min.js"/>
                <!-- <script src="../js/main.js"></script> -->
                <script src="../js/main2.js"/>
                <script src="../js/auxiliar.js"/>
                <script src="https://webrtc.github.io/adapter/adapter-latest.j"/>
